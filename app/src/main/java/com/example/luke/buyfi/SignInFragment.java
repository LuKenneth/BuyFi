...
import static com.example.luke.buyfi.FirebaseManager.RC_SIGN_IN;
                ...
                .addOnCompleteListener(getActivity(), new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Snackbar.make(view.findViewById(R.id.relative_layout), "Authentication Failed.", Snackbar.LENGTH_SHORT).show();
                            //updateUI(null);
                        }
